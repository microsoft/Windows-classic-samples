Windows Firewall Samples (Register Without Category Ownership)
===============================
...
=============================================
     ...
     2. Type msbuild RegisterWithoutCategoryOwnership.
...
=================
     ...
     2. Type RegisterWithoutCategoryOwnership.exe at the command line, or double-click the icon for RegisterWithoutCategoryOwnership.exe to launch it from Windows Explorer.


Additional Run Steps:
=====================
     1. run RegisterWithoutCategoryOwnership.exe
