Asynchronous DNS query API sample
=================================

This sample demonstrates how to asynchronously query DNS records and parse the results.
...
[**DnsQuery**](http://msdn.microsoft.com/en-us/library/windows/desktop/ms682016)

[**DnsQueryEx**](http://msdn.microsoft.com/en-us/library/windows/desktop/hh447188)
...
2.  Go to the directory named for the sample, and double-click the Microsoft Visual Studio Solution (.sln) file titled DnsQueryEx.sln.
