HttpClientWithSslAndClientCertExample

Description
===========

This example shows a HTTP client that sends request-reply messages with SSL transport security using a client certificate.
...
To build the HttpClientWithSslAndClientCertExample sample
  1. Open the solution HttpClientWithSslAndClientCertExample.sln in Visual Studio.
...
To run the HttpClientWithSslAndClientCertExample sample
  1. Run HttpClientWithSslAndClientCertExample by clicking Start Without Debugging on the Debug menu.
