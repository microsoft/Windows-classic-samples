Windows Web Services HTTP custom header purchase order client sample
====================================================================

This sample demonstrates how the [Windows Web Services API](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435) can use custom headers with a service proxy.
