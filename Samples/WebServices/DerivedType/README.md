...
This sample demonstrates how to use the [Windows Web Services API](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435) to read and write derived types using **WsUtil** generated C++ helper functions.For more info about derived type descriptions, see [**WS\_TYPE\_MAPPING**](http://msdn.microsoft.com/en-us/library/windows/desktop/dd323480).
...
[**WS\_TYPE\_MAPPING**](http://msdn.microsoft.com/en-us/library/windows/desktop/dd323480)
