XmlLite encoded XML document reader sample
==========================================

This sample shows how to make an XmlLite app that reads an encoded XML document.The sample includes an XML document encoded as UTF-16.
