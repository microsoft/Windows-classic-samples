StreamingNamedPipeClientExample
...
To build the StreamingNamedPipeClientExample sample
  1. Open the solution StreamingNamedPipeClientExample.sln in Visual Studio.
...
To run the StreamingNamedPipeClientExample sample
  1. Run StreamingNamedPipeClientExample by clicking Start Without Debugging on the Debug menu.
