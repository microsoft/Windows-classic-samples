Windows Web Services HTTP service proxy client with custom channel sample
=========================================================================

This sample shows how to use a service proxy client with the [Windows Web Services API](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435) to talk to an HTTP-based calculator service using a custom channel.The custom channel is a layered channel that delegates all functionality to the existing HTTP channel.
