StreamingNamedPipeServerExample

Description
===========

This example shows a named pipe server that accepts a channel,
...
To build the StreamingNamedPipeServerExample sample
  1. Open the solution StreamingNamedPipeServerExample.sln in Visual Studio.
...
To run the StreamingNamedPipeServerExample sample
  1. Run StreamingNamedPipeServerExample by clicking Start Without Debugging on the Debug menu.
