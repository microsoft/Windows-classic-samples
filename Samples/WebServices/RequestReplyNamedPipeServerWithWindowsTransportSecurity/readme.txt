RequestReplyNamedPipeServerWithWindowsTransportSecurityExample

Description
===========

This example shows a named pipe server that accepts a channel and
...
To build the RequestReplyNamedPipeServerWithWindowsTransportSecurityExample sample
  1. Open the solution RequestReplyNamedPipeServerWithWindowsTransportSecurityExample.sln in Visual Studio.
...
To run the RequestReplyNamedPipeServerWithWindowsTransportSecurityExample sample
  1. Run RequestReplyNamedPipeServerWithWindowsTransportSecurityExample by clicking Start Without Debugging on the Debug menu.
