RequestReplyNamedPipeServerExample
...
To build the RequestReplyNamedPipeServerExample sample
  1. Open the solution RequestReplyNamedPipeServerExample.sln in Visual Studio.
...
To run the RequestReplyNamedPipeServerExample sample
  1. Run RequestReplyNamedPipeServerExample by clicking Start Without Debugging on the Debug menu.
