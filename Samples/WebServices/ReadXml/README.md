Windows Web Services read XML node by node sample
=================================================

This sample demonstrates how to use the [Windows Web Services API](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435) to read XML node by node.
...
[**WsGetReaderProperty**](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430560)

[**WsReadNode**](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430596)
