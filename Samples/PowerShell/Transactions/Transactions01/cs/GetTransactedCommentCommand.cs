// <copyright file="GetTransactedCommentCommand.cs" company="Microsoft Corporation">
...
namespace TransactedComment
{
  ...
  /// <summary>
  /// Contains the implementation of the Get-TransactedComment cmdlet.
  /// </summary>
  /// <remarks>
  ...
  /// </remarks>
  [Cmdlet("Get", "TransactedComment", SupportsTransactions = true)]
  public class GetTransactedCommentCommand : PSCmdlet
  {
    /// <summary>
