XmlLite XML external entity reader sample
=========================================

This sample shows how to use XmlLite to read an XML document with external entities.External entities are references to XML or assets that are defined outside of the current XML document.
