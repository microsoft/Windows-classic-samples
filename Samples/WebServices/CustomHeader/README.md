Windows Web Services custom header sample
=========================================

This sample demonstrates how to use the [Windows Web Services API](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435) to add and retrieve a custom header.
...
2.  Double-click the icon for the **CustomHeader.sln** (solution) file to open the file in Visual Studio.
...
2.  Type **msbuild CustomHeader.sln**.
