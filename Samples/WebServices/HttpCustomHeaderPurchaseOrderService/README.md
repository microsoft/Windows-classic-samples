Windows Web Services HTTP custom header purchase order service sample
=====================================================================

This sample demonstrates how the [Windows Web Services API](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435) can use the service host for hosting a PurchaseOrder service over HTTP.
...
[**WsAddCustomHeader**](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430479)

[**WsGetCustomHeader**](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430537)
