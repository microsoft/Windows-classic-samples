Windows Web Services HTTP calculator service sample
===================================================

This sample demonstrates how the [Windows Web Services API](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435) can use the service host to host a calculator service over HTTP.
...
[Windows Web Services HTTP calculator client sample](http://go.microsoft.com/fwlink/p/?linkid=258657)
