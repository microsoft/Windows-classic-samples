List View Sample
===============================
This sample shows how to create and use a bitmap atlas to create and animate window style list views. The list view loads the files and directories from the current directory with the icons. 
