...
This sample performs streaming only on application layer. On transport layer data are buffered before
they are returned to the client. Streaming mode is supported only on HTTP channels.
