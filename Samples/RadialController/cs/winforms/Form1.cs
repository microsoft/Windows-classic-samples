...
namespace RadialControllerWinForms
{
    public partial class Form1 : Form
    {
        ...
        {
            // Using custom font
            string fontFilePath = GetSharedFilePath("fontawesome-webfont.ttf");
            radialController.Menu.Items.Add(RadialControllerMenuItem.CreateFromFontGlyph("Custom Font Icon", "\xf0a1", "FontAwesome", new Uri(fontFilePath)));
