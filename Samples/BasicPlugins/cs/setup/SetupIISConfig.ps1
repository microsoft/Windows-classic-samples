...
Function ParseCommandLine
{
    ...
    ValidateAndCopyFiles -path $path -cfgfile $cfgfile -svc $svc -schema $schema -dispatchXml $dispatchXml -customPluginAssembly $customPluginAssembly
...
ParseCommandLine -site $site -path $path -cfgfile $cfgfile -port $port -app $app -svc $svc -schema $schema -dispatchXml $dispatchXml -customPluginAssembly $customPluginAssembly
