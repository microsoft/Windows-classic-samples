Central access policy ID lookup sample
======================================

Sample program for retrieving the Central Access Policy IDs on a machine, then look up the details of those policies from Active Directory.
...
2.  Go to the directory named for the sample, and double-click the Microsoft Visual Studio Solution (.sln) file titled .sln.
