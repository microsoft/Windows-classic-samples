...
=======================================
     1. Open Windows Explorer and navigate to StopProcess under the samples directory.
...
=================
     ...
     3. Run installutil "StopProcessSample.dll"
     4. Start PowerShell
     5. Run Add-PSSnapin StopProcMCPPPSSnapIn (this adds the PowerShell snap-in to the shell)
