Windows Web Services TCP calculator service sample
==================================================

This sample demonstrates how to use the [Windows Web Services API](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430435) to implement a calculator service using the [Service Host](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430449) over TCP.
...
[Service Host](http://msdn.microsoft.com/en-us/library/windows/desktop/dd430449)
