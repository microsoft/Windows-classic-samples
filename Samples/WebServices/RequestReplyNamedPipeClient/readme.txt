RequestReplyNamedPipeClientExample

Description
===========

This example shows a named pipe client that sends request-reply messages.
...
To build the RequestReplyNamedPipeClientExample sample
  1. Open the solution RequestReplyNamedPipeClientExample.sln in Visual Studio.
...
To run the RequestReplyNamedPipeClientExample sample
  1. Run RequestReplyNamedPipeClientExample by clicking Start Without Debugging on the Debug menu.
