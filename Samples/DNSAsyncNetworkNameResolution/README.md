Asynchronous Winsock network name resolution sample
===================================================

This sample demonstrates how to Winsock to use asynchronously resolve network names using the [**GetAddrInfoEx**](http://msdn.microsoft.com/en-us/library/windows/desktop/ms738518) API.
...
[**GetAddrInfoEx**](http://msdn.microsoft.com/en-us/library/windows/desktop/ms738518)
