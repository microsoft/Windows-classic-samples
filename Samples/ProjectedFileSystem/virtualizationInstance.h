...
protected:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Getter/Setter methods.  The derived provider class uses SetImplementedOptionalMethods to tell
    // the class which optional callbacks it overrode.  This is required because ProjFS detects whether
    // a provider implemented an optional callback by whether or not the provider supplied a pointer to
    // the callback in the callbacks parameter of PrjStartVirtualizing().
    ///////////////////////////////////////////////////////////////////////////////////////////////
