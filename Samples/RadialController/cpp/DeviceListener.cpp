...
HRESULT DeviceListener::AddMenuItemFromSystemFont()
{
    ...
    menuItemStatics2->CreateFromFontGlyphWithUri(toolDisplayName, HStringReference(L"\uf0a1").Get(), HStringReference(L"FontAwesome").Get(), fontUri.Get(), &customFontItem);
...
HRESULT DeviceListener::GetFontUri(_Out_ ComPtr<IUriRuntimeClass>* fontUri)
{
    ...
    WCHAR fontFile[] = L"..\\shared\\fontawesome-webfont.ttf";
