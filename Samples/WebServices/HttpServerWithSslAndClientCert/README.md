...
This example demonstrates an HTTP server that accepts a channel and receives and replies to messages with SSL transport security using a client certificate.
