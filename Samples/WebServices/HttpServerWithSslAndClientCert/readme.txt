HttpServerWithSslAndClientCertExample

Description
===========

This example shows an HTTP server that accepts a channel and
receives and replies to messages with SSL transport security using a client certificate.
...
To build the HttpServerWithSslAndClientCertExample sample
  1. Open the solution HttpServerWithSslAndClientCertExample.sln in Visual Studio.
...
To run the HttpServerWithSslAndClientCertExample sample
  1. Run HttpServerWithSslAndClientCertExample by clicking Start Without Debugging on the Debug menu.
