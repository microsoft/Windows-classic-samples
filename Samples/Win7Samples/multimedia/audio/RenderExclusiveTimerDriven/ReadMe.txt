========================================================================
    WASAPI Render Exclusive Timer Driven Sample
========================================================================

This sample demonstrates rendering audio data using WASAPI.

The sample renders audio in exclusive mode using the timer driven programming model.
...
WASAPIRenderExclusiveTimerDriven.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named WASAPIRenderExclusiveTimerDriven.pch and a precompiled types file named StdAfx.obj.
...
To run the sample:
=================
    Type WASAPIRenderExclusiveTimerDriven.exe at the command line
