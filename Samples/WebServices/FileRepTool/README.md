Windows Web Services file replace client sample
===============================================

This command line tool drives the Windows Web Services file replace service sample.
...
2.  Double-click the icon for the **FileRepTool.sln** (solution) file to open the file in Visual Studio.
...
2.  Type **msbuild FileRepTool.sln**.
