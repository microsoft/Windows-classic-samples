...
//
//  Description:
//      Add items to a context menu.  This is called each time the context menu
//      is invoked.
//
//  Arguments:
//      piDataIn
//          IUnkown pointer from which to obtain interfaces for obtaining data
//          describing the object for which the context menu is being
//          displayed.
//
//      piCallbackIn
...
//      E_NOTIMPL       Not implemented for this type of data.
//      hr             Any error codes returned by HrSaveData().
//
//--
/////////////////////////////////////////////////////////////////////////////
STDMETHODIMP
    ...
    )
{
    ...
    if ( (piDataIn == NULL) || (piCallbackIn == NULL) )
    {
        hr = E_INVALIDARG;
        goto Cleanup;
    } // if: not all interfaces not specified
    ...
    try
    {
        ...
        hr = m_podObjData->AddContextMenuItems( piCallbackIn );
        if ( FAILED( hr ) )
        {
            goto Cleanup;
        } // if:  error saving data from host
    ...
    catch ( CMemoryException * pme )
    {
        ...
        TRACE( _T("CExtObject::AddContextMenuItems() - Failed to add menu items\n") );
...
//      piDataIn
//          IUnkown pointer from which to obtain interfaces for obtaining data
//          describing the object for which the command is to be invoked.
//
//  Return Value:
//      S_OK         Command invoked successfully.
//      E_INVALIDARG    Invalid arguments to the function.
//      E_NOTIMPL       Not implemented for this type of data.
//      hr             Any error codes from HrSaveData().
//
//--
/////////////////////////////////////////////////////////////////////////////
HRESULT
    ...
    )
{
    ...
    try
    {
        ...
        ASSERT( m_podObjData != NULL );
        hr = m_podObjData->InvokeCommand( nCommandIDIn );
        if ( FAILED( hr ) )
        {
            goto Cleanup;
        } // if:
    ...
    catch ( CMemoryException * pme )
    {
        ...
        TRACE( _T("CExtObject::InvokeCommand() - Invoking the context menu command failed\n") );
